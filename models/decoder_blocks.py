...
from diffusers.models.dual_transformer_2d import DualTransformer2DModel, Transformer2DModel
...
class UNetMidBlock2DCrossAttn(nn.Module):
    ...
    def set_use_memory_efficient_attention_xformers(self, use_memory_efficient_attention_xformers: bool):
        for attn in self.attentions:
            attn.set_use_memory_efficient_attention_xformers(use_memory_efficient_attention_xformers)
...
class CrossAttnUpBlock2D(nn.Module):
    def __init__(
        ...
        for i in range(num_layers):
            # res_skip_channels = in_channels df_if (i == num_layers - 1) else out_channels
            res_skip_channels = 0
            resnet_in_channels = prev_output_channel if i == 0 else out_channels
