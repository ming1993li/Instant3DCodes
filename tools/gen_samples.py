...
from training.generator import TriPlaneGenerator
...
@click.option('--class', 'class_idx', type=int, help='Class label (unconditional df_if not specified)')
...
def generate_images(
    ...
    # Specify reload_modules=True df_if you want code modifications to take effect; otherwise uses pickled code
    if reload_modules:
